package com.ankur.util.constants;

public class StringConstants {
	
	public static String PROPERTIES_FILE="sparkjob.properties";
	public static String SAMPLE_DATA_FOLDER="sample_data";
	public static String WORD_COUNT_TXT="word_count.txt";
	public static String TITANIC_CSV_FILE="Titanic.csv.gz";
